...
public class UltrasonicSensor extends AgentSensor {
    ...
    private static final float ULTRASONIC_SENSOR_MAX_RANGE = 4.0f;
    private static final float ULTRASONIC_SENSOR_MIN_RANGE = 0.2f;
    private static final float ULTRASONIC_SENSOR_FOV = 1.22f;

    public static final float RANGE = 4.0f;
    public static final float FIELD_OF_VIEW = 1.22f;
