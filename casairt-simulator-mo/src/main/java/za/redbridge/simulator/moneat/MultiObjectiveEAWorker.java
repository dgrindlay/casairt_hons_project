 ...
 */
public class MultiObjectiveEAWorker implements Callable<Object> {
	 ...
	 *            The species.
	 */
	public MultiObjectiveEAWorker(final MultiObjectiveBasicEA theTrain, final Species theSpecies) {
		this.train = theTrain;
