 ...
 */
public class MultiObjectiveTrainEA extends MultiObjectiveBasicEA implements MLTrain {
	 ...
	 */
	public MultiObjectiveTrainEA(Population thePopulation, Population archivePopulation, ScoreCalculator theScoreFunction, int archiveSize) {
		super((MultiObjectivePopulation) thePopulation, (MultiObjectivePopulation) archivePopulation ,theScoreFunction, archiveSize);
	}
