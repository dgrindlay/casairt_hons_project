...
/**
 *  Reads in sensor morphology for robots to be created
 */
                ...
                if (checkFieldPresent(sensor, sid)) {
                    ...
                    if (checkFieldPresent(type, sid+":type")) {
                        if(type.equalsIgnoreCase("ProximitySensor")){
                            agentSensor = new ProximitySensor((float) Math.toRadians(bearing), orientation, 1);
                        }
                            ...
                            agentSensor = new UltrasonicSensor((float) Math.toRadians(bearing), orientation, 1);
                        }
                            ...
                            agentSensor = new ColourRangedSensor((float) Math.toRadians(bearing), orientation, 3);
                        }
                            ...
                            agentSensor = new ConstructionSensor((float) Math.toRadians(bearing), orientation, 3);
                        }
