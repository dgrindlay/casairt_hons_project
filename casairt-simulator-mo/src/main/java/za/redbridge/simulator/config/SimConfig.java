...
/*
 *  Reads in simulation parameters from a file and stores them to be used to create the simulator
 *
*/
...
public class SimConfig extends Config {
    ...
    public SimConfig(String filepath) throws IOException{
        ...
        nObjectives = (Integer)(config.get("objectives"));
    ...
    public void setSimulationIterations(int value){
        this.simulationIterations = value;
    }
